...
public class Surfacee : MonoBehaviour
{
        ...
        public void MakingListOfPoints()
        {
            ...
            {
                CRpointsPOSS.Add(MotherCRPoints.GetChild(i).position);
...

        {
            ...
            List<Vector3> pointsPArt4 = new List<Vector3>();
        ...
        for (int i = 0; i < 4; i++)
            {
                ...
                pointsPArt2.Add(PointPos[i + 4]);
                pointsPArt3.Add(PointPos[i + 8]);
                pointsPArt4.Add(PointPos[i + 12]);
            ...
            Allpointspos.Add(CalCurve(u, pointsPArt4));
        ...
        public void UpdateMesh()
        {
            ...
            this.GetComponent<MeshCollider>().sharedMesh = meshh;
        }
